...
public class ServiceController {
    ...
    public ResponseEntity<List<ServiceEntity>> getServicesByCategoryId(@PathVariable String categoryId) {
        return new ResponseEntity<>(serviceService.getServicesByCategoryId(categoryId), HttpStatus.OK);
    }
